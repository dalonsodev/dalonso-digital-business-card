export default function Info() {
   return (
      <section>
         <div className="main-image" aria-label="Portrait picture of Dalonso"></div>
         <div className="info-container">
            <div className="info-text">
               <h1>David Alonso</h1>
               <span>Frontend Developer</span>
               <small>
                  <a href="/">dalonso.website</a>
               </small>
            </div>
            <div className="info-buttons">
               <a 
                  className="btn btn-email" 
                  href="mailto:masdavidalonso@gmail.com"
               >
               ...
               <a 
                  className="btn btn-alt btn-linkedin" 
                  href="https://www.linkedin.com/in/davidmartinezalonso/"
               >
